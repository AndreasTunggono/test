          ...
          value: function (t, e) {
            ...
            return (
              ...
              (f.isIE() && "radialBar" === h.config.chart.type) ||
                ...
                t.filter(function (t) {
                  var e = null;
                  (e = f.isSafari() || f.isFirefox() || f.isIE() ? t.flood(n, o).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(r) : t.flood(n, o).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(r).merge(t.source)),
                    t.blend(t.source, e);
                }),
        ...
        },
        {
          ...
          value: function (t) {
            ...
            h.config.chart.animations.animateGradually.enabled && (c = h.config.chart.animations.animateGradually.delay),
              ...
              this.morphSVG(e, i, a, "line" !== h.config.chart.type || h.globals.comboCharts ? s : "stroke", r, n, o, l * c);
          },
        },
        {
          ...
          value: function (t, e, i, a, s, r, n, o) {
            ...
            (!s || s.indexOf("undefined") > -1 || s.indexOf("NaN") > -1) && (s = c()),
              ...
              t
                ...
                .afterAll(function () {
                  f.isNumber(i)
                    ? i === h.globals.series[h.globals.maxValsInArrayIndex].length - 2 && h.globals.shouldAnimate && l.animationCompleted(t)
                    : "none" !== a && h.globals.shouldAnimate && ((!h.globals.comboCharts && e === h.globals.series.length - 1) || h.globals.comboCharts) && l.animationCompleted(t),
        ...
        [
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                d.attr({ x: t, y: e, width: i > 0 ? i : 0, height: a > 0 ? a : 0, rx: s, ry: s, opacity: n, "stroke-width": null !== o ? o : 0, stroke: null !== l ? l : "none", "stroke-dasharray": h }), d.node.setAttribute("fill", r), d
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                b.globals.dom.Paper.path(i).attr({ fill: o, "fill-opacity": h, stroke: s, "stroke-opacity": d, "stroke-linecap": f, "stroke-width": n, "stroke-dasharray": x, class: g })
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              y && (M.node.addEventListener("mouseenter", this.pathMouseEnter.bind(this, M)), M.node.addEventListener("mouseleave", this.pathMouseLeave.bind(this, M)), M.node.addEventListener("mousedown", this.pathMouseDown.bind(this, M))),
                M.attr({ pathTo: r, pathFrom: s });
              var X = { el: M, j: i, realIndex: a, pathFrom: s, pathTo: r, fill: c, strokeWidth: l, delay: d };
              return (
                !L || A.globals.resized || A.globals.dataChanged ? (!A.globals.resized && A.globals.dataChanged) || C.showDelayedElements() : C.animatePathsGradually(n(n({}, X), {}, { speed: g })),
                A.globals.dataChanged && P && T && C.animatePathsGradually(n(n({}, X), {}, { speed: u })),
                M
              );
            },
          },
          ...
          },
          {
            ...
            value: function (t, e, i, a, s) {
              ...
              if (
                ...
                "bubble" !== c.config.chart.type ? r.attr({ gradientUnits: "userSpaceOnUse", cx: b, cy: m, r: n }) : r.attr({ cx: 0.5, cy: 0.5, r: 0.8, fx: 0.2, fy: 0.2 });
            ...
            value: function (t) {
              ...
              return (
                ...
                (e = Array.isArray(s)
                  ...
                  : p.globals.dom.Paper.text(function (t) {
                      return t.tspan(s);
                    })).attr({ x: i, y: a, "text-anchor": r, "dominant-baseline": "auto", "font-size": n, "font-family": o, "font-weight": l, fill: h, class: "apexcharts-text " + g }),
          ...
          },
          {
            ...
            value: function () {
              var t,
                ...
                l = 0.1,
                h = 0;
              if (((s.yRange = []), s.isMultipleYAxis)) for (var c = 0; c < s.minYArr.length; c++) s.yRange.push(Math.abs(s.minYArr[c] - s.maxYArr[c])), o.push(0);
      ...
      a(t, [
        {
          ...
          value: function (t, e, i) {
            ...
            a.config.yaxis[t.yAxisIndex].logarithmic
              ? (o = (l = new y(this.annoCtx.ctx).getLogVal(l, t.yAxisIndex)) / a.globals.yLogRatio[t.yAxisIndex])
            ...
            if (
              ...
              a.config.yaxis[t.yAxisIndex] && a.config.yaxis[t.yAxisIndex].reversed && ((r = o + parseFloat(t.label.style.fontSize) + t.marker.size), (n = o)),
              f.isNumber(s))
            ) {
              var c = {
                  pSize: t.marker.size,
          ...
          value: function () {
            return {
              ...
              chart: {
                ...
                offsetX: 0,
                offsetY: 0,
                selection: { enabled: !1, type: "x", fill: { color: "#24292e", opacity: 0.1 }, stroke: { width: 1, color: "#24292e", opacity: 0.4, dashArray: 3 }, xaxis: { min: void 0, max: void 0 }, yaxis: { min: void 0, max: void 0 } },
                sparkline: { enabled: !1 },
      ...
      a(t, [
        {
          ...
          value: function (t) {
            ...
            h.appendChild(c),
              ...
              b.setAttrs(c, { x: 0, y: 0, preserveAspectRatio: "none", width: o + "px", height: l + "px" }),
        ...
        },
        {
          ...
          value: function (t) {
            ...
            var h = n;
            if (
              (-1 === n.indexOf("rgb") ? n.length < 9 && (h = f.hexToRgba(n, l)) : n.indexOf("rgba") > -1 && (l = f.getOpacityFromRGBA(n)),
        ...
        },
        {
          ...
          value: function (t, e, i, a) {
            ...
            Array.isArray(s.fill.pattern.style)
              ? (t = void 0 !== s.fill.pattern.style[r.seriesNumber] ? n.drawPattern(s.fill.pattern.style[r.seriesNumber], s.fill.pattern.width, s.fill.pattern.height, l, o, i) : a)
            ...
            if (void 0 === s.fill.gradient.gradientToColors || 0 === s.fill.gradient.gradientToColors.length)
              a =
                "dark" === s.fill.gradient.shade
                  ? o.shadeColor(-1 * parseFloat(s.fill.gradient.shadeIntensity), t.indexOf("rgb") > -1 ? f.rgb2hex(t) : t)
                  : o.shadeColor(parseFloat(s.fill.gradient.shadeIntensity), t.indexOf("rgb") > -1 ? f.rgb2hex(t) : t);
              ...
              for (var d = 0; d < l.x.length; d++) {
                ...
                if (x || r) {
                  ...
                  n.config.series[o].data[g] &&
                    (n.config.series[o].data[g].fillColor && (m.pointFillColor = n.config.series[o].data[g].fillColor), n.config.series[o].data[g].strokeColor && (m.pointStrokeColor = n.config.series[o].data[g].strokeColor)),
                    a && (m.pSize = a),
        ...
        },
        {
          ...
          value: function (t, e, i, a, s, r, n) {
            var o = this.w,
              ...
              v = u.drawCircle(i);
            if (
              (o.config.series[l].data[r] && o.config.series[l].data[r].fillColor && (m = o.config.series[l].data[r].fillColor),
              v.attr({ cx: t, cy: e, fill: m, stroke: f.pointStrokeColor, r: a, "stroke-width": f.pWidth, "stroke-dasharray": f.pointStrokeDashArray, "stroke-opacity": f.pointStrokeOpacity }),
      ...
      a(t, [
        {
          ...
          value: function (t) {
            ...
            return (
              (k = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(z) : this.calculateColumnsDataLabelsPosition(z)),
              u.attr({ cy: k.bcy, cx: k.bcx, j: n, val: l[r][n], barHeight: h, barWidth: c }),
              this.drawCalculatedDataLabels({ x: k.dataLabelsX, y: k.dataLabelsY, val: this.barCtx.isTimelineBar ? [a, s] : l[r][n], i: o, j: n, barWidth: c, barHeight: h, textRects: P, dataLabelsConfig: A })
            );
          },
        },
        {
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (c.enabled && !m) {
              ...
              if (
                ("vertical" === d.config.plotOptions.bar.dataLabels.orientation && ("top" === w && (c.textAnchor = y ? "end" : "start"), "center" === w && (c.textAnchor = "middle"), "bottom" === w && (c.textAnchor = y ? "end" : "start")),
              ...
              this.barCtx.isHorizontal && a < 0 && ("start" === c.textAnchor ? (k.textAnchor = "end") : "end" === c.textAnchor && (k.textAnchor = "start")),
                u.plotDataLabelsText({ x: e, y: i, text: v, i: s, j: r, parent: x, dataLabelsConfig: k, alwaysDrawDataLabel: !0, offsetCorrection: !0 });
            }
            return x;
          },
        },
        ...
        },
        {
          ...
          value: function (t) {
            ...
            return (
              ...
              { pathTo: (m = m + g.line(p, f.y2) + f.endingPath + g.line(x - n, f.y2) + g.line(x - n, f.y1) + f.startingPath + "z"), pathFrom: (v = v + g.line(p, s) + g.line(x - n, s) + g.line(x - n, s) + g.line(x - n, s) + g.line(p, s)) }
            );
          },
        },
        {
          ...
          value: function (t, e, i, a, s) {
            ...
            if (void 0 !== i[a][s] || null !== i[a][s]) {
              ...
              switch (
                ...
                "rounded" === this.barCtx.barOptions.endingShape && (p += v / 2),
                "rounded" === this.barCtx.barOptions.startingShape && (x -= v / 2),
                this.barCtx.barOptions.endingShape)
              ) {
                case "flat":
          ...
          value: function (t, e) {
            ...
            for (var o = 0, l = 0; o < t.length; o++, l++) {
              ...
              for (var C = a.group({ class: "apexcharts-datalabels", "data:realIndex": v }), L = 0; L < i.globals.dataPoints; L++) {
                ...
                this.isHorizontal
                  ? ((T = this.drawBarPaths(n(n({}, z), {}, { barHeight: k, zeroW: g, yDivision: c }))), (A = this.series[o][L] / this.invertedYRatio))
                  : ((T = this.drawColumnPaths(n(n({}, z), {}, { xDivision: h, barWidth: A, zeroH: d }))), (k = this.series[o][L] / this.yRatio[this.yaxisIndex])),
                  (p = T.y),
                  (u = T.x),
                  L > 0 && m.push(u + A / 2),
                  x.push(p);
        ...
        },
        {
          ...
          value: function (t) {
            ...
            return (
              ...
              this.barHelpers.barBackground({ bc: u, j: g, i: d, x1: p - o / 2 - r * this.visibleI, x2: r * this.seriesLen + o / 2, elSeries: l }),
      ...
      a(s, [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            return (
              (a = l.config.plotOptions.bar.rangeBarGroupRows ? s + n * g : s + r * this.visibleI + n * g),
              u > -1 &&
                !l.config.plotOptions.bar.rangeBarOverlap &&
                (h = l.globals.seriesRangeBarTimeline[e][u].overlaps).indexOf(c) > -1 &&
                (a = (r = o.barHeight / h.length) * this.visibleI + (n * (100 - parseInt(this.barOptions.barHeight, 10))) / 100 / 2 + r * (this.visibleI + h.indexOf(c)) + n * g),
      ...
      a(i, [
        {
          ...
          value: function (e) {
            ...
            if (a && "object" === t(a)) {
              var l = {};
              (l = -1 !== ["line", "area", "bar", "candlestick", "rangeBar", "histogram", "bubble", "scatter", "heatmap", "treemap", "pie", "polarArea", "donut", "radar", "radialBar"].indexOf(a.chart.type) ? r[a.chart.type]() : r.line()),
                ...
                (((a = this.checkForCatToNumericXAxis(this.chartType, l, a)).chart.sparkline && a.chart.sparkline.enabled) || (window.Apex.chart && window.Apex.chart.sparkline && window.Apex.chart.sparkline.enabled)) &&
                  (l = r.sparkline(l)),
                (o = f.extend(n, l));
            }
        ...
        },
        {
          ...
          value: function (t, e, i) {
            ...
            if ("array" === t) {
              ...
              if (5 === e[i].data[0].length) for (var h = 0; h < e[i].data.length; h++) s.push(e[i].data[h][1]), r.push(e[i].data[h][2]), n.push(e[i].data[h][3]), o.push(e[i].data[h][4]);
              else for (var c = 0; c < e[i].data.length; c++) s.push(e[i].data[c][1][0]), r.push(e[i].data[c][1][1]), n.push(e[i].data[c][1][2]), o.push(e[i].data[c][1][3]);
            } else if ("xy" === t) {
          ...
          value: function (t) {
            ...
            for (
              ...
              if ((("rangeBar" !== a.chart.type && "rangeArea" !== a.chart.type && "rangeBar" !== t[l].type && "rangeArea" !== t[l].type) || ((s.isRangeData = !0), this.handleRangeData(t, l)), this.isMultiFormat()))
                ...
                "datetime" === a.xaxis.type ? ((s.isXNumeric = !0), o(), s.seriesX.push(this.twoDSeriesX)) : "numeric" === a.xaxis.type && ((s.isXNumeric = !0), n.length > 0 && ((this.twoDSeriesX = n), s.seriesX.push(this.twoDSeriesX))),
                  s.labels.push(this.twoDSeriesX);
      ...
      a(t, [
        ...
        },
        {
          ...
          value: function (t, e, i) {
            var a = this.w;
            return (
              f.isNumber(t) && (t = 0 !== a.globals.yValueDecimal ? t.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : a.globals.yValueDecimal) : a.globals.maxYArr[i] - a.globals.minYArr[i] < 5 ? t.toFixed(1) : t.toFixed(0)), t
            );
          },
        },
        {
        ...
        },
        {
          ...
          value: function (t) {
            ...
            o.push(n.config.chart.toolbar.export.csv.headerCategory),
              ...
              n.globals.axisCharts || (o.push(n.config.chart.toolbar.export.csv.headerValue), l.push(o.join(a))),
              i.map(function (t, e) {
                  ...
                  ? (function (t, e) {
                      if ((o.length && 0 === e && l.push(o.join(a)), t.data && t.data.length))
                        for (var s = 0; s < t.data.length; s++) {
                          ...
                          ("candlestick" === n.config.chart.type || (t.type && "candlestick" === t.type)) &&
                            (o.pop(), o.push(n.globals.seriesCandleO[e][s]), o.push(n.globals.seriesCandleH[e][s]), o.push(n.globals.seriesCandleL[e][s]), o.push(n.globals.seriesCandleC[e][s])),
                            "rangeBar" === n.config.chart.type && (o.pop(), o.push(n.globals.seriesRangeStart[e][s]), o.push(n.globals.seriesRangeEnd[e][s])),
                            o.length && l.push(o.join(a));
                        }
                      var d;
                    })(t, e)
                  : ((o = []).push(n.globals.labels[e].split(a).join("")), o.push(n.globals.series[e]), l.push(o.join(a)));
              }),
              (h += l.join(r)),
              this.triggerDownload(encodeURI(h), n.config.chart.toolbar.export.csv.filename, ".csv");
          },
        },
        {
          key: "triggerDownload",
                  ...
                  if (
                    ((c =
                      void 0 !== i.config.xaxis.tickAmount && "dataPoints" !== i.config.xaxis.tickAmount && "datetime" !== i.config.xaxis.type
                        ...
                        : e.axesUtils.checkForOverflowingLabels(s, c, h, e.drawnLabels, e.drawnLabelsRects)).text && i.globals.xaxisLabelsCount++,
        ...
        },
        {
          ...
          value: function (t) {
            ...
            (0 === e && l.globals.skipFirstTimelinelabel) ||
              ...
              (l.config.grid.xaxis.lines.show && this._drawGridLine({ x1: i, y1: a, x2: s, y2: r, parent: o }), new G(this.ctx).drawXaxisTicks(i, this.elg));
          },
        },
        {
          key: "_drawGridLine",
          ...
          value: function (t) {
            ...
            if (i.config.grid.xaxis.lines.show || i.config.xaxis.axisTicks.show)
              for (var a, s = i.globals.padHorizontal, r = i.globals.gridHeight, n = 0; n < e + 1; n++) {
                i.config.grid.xaxis.lines.show && this._drawGridLine({ x1: s, y1: 0, x2: a, y2: r, parent: this.elgridLinesV }), new G(this.ctx).drawXaxisTicks(s, this.elg), (a = s = s + i.globals.gridWidth / e + 0.3);
              }
      ...
      a(t, [
        {
          ...
          value: function (t, e) {
            var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 10,
              ...
              n = Math.abs(e - t);
            if (
              ("dataPoints" === (i = this._adjustTicksForSmallRange(i, a, n)) && (i = r.globals.dataPoints - 1),
              ...
              for (var g = 0; g < r.series[d].length; g++) {
                ...
                null !== u && f.isNumber(u)
                  ? ((n = Math.max(n, c[d][g])),
                    (e = Math.min(e, h[d][g])),
                    (i = Math.max(i, h[d][g])),
                    "candlestick" === this.w.config.chart.type && ((n = Math.max(n, r.seriesCandleO[d][g])), (n = Math.max(n, r.seriesCandleH[d][g])), (n = Math.max(n, r.seriesCandleL[d][g])), (i = n = Math.max(n, r.seriesCandleC[d][g]))),
                    f.isFloat(u) && ((u = f.noExponents(u)), (r.yValueDecimal = Math.max(r.yValueDecimal, u.toString().split(".")[1].length))),
                    o > h[d][g] && h[d][g] < 0 && (o = h[d][g]))
                  : (r.hasNullValues = !0);
              }
            }
            return (
              "rangeBar" === s.chart.type && r.seriesRangeStart.length && r.isBarHorizontal && "datetime" === s.xaxis.type && (o = e),
            ...
            if (
              (e.yaxis.forEach(function (e, i) {
                void 0 !== e.max && ("number" == typeof e.max ? (t.maxYArr[i] = e.max) : "function" == typeof e.max && (t.maxYArr[i] = e.max(t.isMultipleYAxis ? t.maxYArr[i] : t.maxY)), (t.maxY = t.maxYArr[i])),
                  void 0 !== e.min &&
                    ("number" == typeof e.min ? (t.minYArr[i] = e.min) : "function" == typeof e.min && (t.minYArr[i] = e.min(t.isMultipleYAxis ? (t.minYArr[i] === Number.MIN_VALUE ? 0 : t.minYArr[i]) : t.minY)), (t.minY = t.minYArr[i]));
              }),
              t.isBarHorizontal)
            ) {
              ...
              i.config.yaxis.map(function (o, l) {
                ...
                o.opposite
                  ? i.globals.isBarHorizontal
                    ...
                    : ((s = i.globals.gridWidth + i.globals.translateX + n), h || (n = n + c + 20), (i.globals.translateYAxisX[l] = s - o.labels.offsetX + 20))
                  : ((a = i.globals.translateX - r), h || (r = r + c + 20), (i.globals.translateYAxisX[l] = a + o.labels.offsetX));
              });
          },
        },
        {
          ...
          value: function () {
            ...
            if (t.config.xaxis.crosshairs.show) {
              ...
              1 === t.config.xaxis.crosshairs.width && (w = e.drawLine()),
                ...
                d && (w = i.dropShadow(w, { left: g, top: u, blur: x, color: m, opacity: v })),
      ...
      a(t, [
        ...
        },
        {
          ...
          value: function () {
            ...
            return (
              null !== e && !t.config.legend.floating && t.config.legend.show ? (this.dCtx.lgRect = { x: i.x, y: i.y, height: i.height, width: 0 === i.height ? 0 : i.width }) : (this.dCtx.lgRect = { x: 0, y: 0, height: 0, width: 0 }),
          ...
          value: function () {
            ...
            if ((e.config.xaxis.convertedCatToNumeric && 0 === i.length && (i = e.globals.categoryLabels), e.globals.timescaleLabels.length > 0)) {
              ...
              var o = new W(this.dCtx.ctx),
                l = r;
              (r = o.xLabelFormat(s, r, l, { i: void 0, dateFormatter: new Y(this.dCtx.ctx).formatDate, w: e })),
                (n = o.xLabelFormat(s, n, l, { i: void 0, dateFormatter: new Y(this.dCtx.ctx).formatDate, w: e })),
              ...
              if (
                ...
                ((t = { width: c.width >= d.width ? c.width : d.width, height: c.height >= d.height ? c.height : d.height }).width * i.length >
                  ...
                  (function (t) {
                    if (e.dCtx.timescaleLabels && e.dCtx.timescaleLabels.length) {
                      ...
                      "datetime" === r
                        ...
                        : "datetime" !== r && e.dCtx.gridPad.right < n / 2 - e.dCtx.yAxisWidthRight && !a.rotateXLabels && ("between" !== i.config.xaxis.tickPlacement || i.globals.isBarHorizontal) && (e.dCtx.xPadRight = n / 2 + 1);
                  })();
              };
        ...
        },
        {
          ...
          value: function () {
            ...
            ("radar" === e.config.chart.type || this.isSparkline) && ((o = 0), (l = i.goldenPadding)),
              ...
              (this.isSparkline || "treemap" === e.config.chart.type) && ((o = 0), (l = 0), (h = 0)),
          ...
          value: function (t, e, i) {
            ...
            if (t.length > 0) {
              for (var r = 0; r < t.length; r++)
                t[r].index === i &&
                  (a.globals.axisCharts ? ((s[i].data = t[r].data.slice()), t.splice(r, 1), e.splice(r, 1), a.globals.risingSeries.push(i)) : ((s[i] = t[r].data), t.splice(r, 1), e.splice(r, 1), a.globals.risingSeries.push(i)));
          ...
          value: function () {
            ...
            for (var n = e.globals.legendFormatter, o = e.config.legend.inverseOrder, l = o ? a.length - 1 : 0; o ? l >= 0 : l <= a.length - 1; o ? l-- : l++) {
              ...
              (C.background = s[l]),
                ...
                void 0 !== e.globals.seriesColors[l] && ((C.background = e.globals.seriesColors[l]), (C.color = e.globals.seriesColors[l])),
                ...
                e.config.legend.markers.customHTML &&
                  (Array.isArray(e.config.legend.markers.customHTML) ? e.config.legend.markers.customHTML[l] && (p.innerHTML = e.config.legend.markers.customHTML[l]()) : (p.innerHTML = e.config.legend.markers.customHTML())),
              ...
              T || (T = e.config.chart.foreColor),
                ...
                b.setAttrs(P, { rel: l + 1, i: l, "data:default-text": encodeURIComponent(h), "data:collapsed": c || d }),
                L.appendChild(p),
                L.appendChild(P);
              ...
              e.config.legend.showForNullSeries || (z.isSeriesNull(l) && -1 === e.globals.collapsedSeriesIndices.indexOf(l) && -1 === e.globals.ancillaryCollapsedSeriesIndices.indexOf(l) && L.classList.add("apexcharts-hidden-null-series")),
          ...
          value: function (t) {
            ...
            for (var i = 0; i < e.length; i++)
              this.elMenuItems.push(document.createElement("div")),
                ...
                b.setAttrs(this.elMenuItems[i], { class: "apexcharts-menu-item ".concat(e[i].name), title: e[i].title }),
        ...
        },
        {
          ...
          value: function (t) {
            var e = t.context,
              ...
              g = {};
            return (
              Math.abs(c + n) > a.globals.gridWidth ? (c = a.globals.gridWidth - n) : s.clientX - r.left < 0 && (c = n),
              n > s.clientX - r.left && ((l = !0), (c = Math.abs(c))),
              o > s.clientY - r.top && ((h = !0), (d = Math.abs(d))),
              (g =
                "x" === i ? { x: l ? n - c : n, y: 0, width: c, height: a.globals.gridHeight } : "y" === i ? { x: 0, y: h ? o - d : o, width: a.globals.gridWidth, height: d } : { x: l ? n - c : n, y: h ? o - d : o, width: c, height: d }),
        ...
        },
        {
          ...
          value: function (t) {
            ...
            a.globals.isTimelineBar
              ? ((h = a.globals.yAxisScale[0].niceMin + s.startX * r.invertedYRatio), (c = a.globals.yAxisScale[0].niceMin + s.endX * r.invertedYRatio))
              : ((h = a.globals.xAxisScale.niceMin + s.startX * r.xRatio), (c = a.globals.xAxisScale.niceMin + s.endX * r.xRatio));
            var d = [],
              g = [];
            if (
              ...
              if (a.globals.zoomEnabled) {
                ...
                if (
                  ((a.globals.zoomed = !0),
                  a.config.xaxis.convertedCatToNumeric && ((h = Math.floor(h)), (c = Math.floor(c)), h < 1 && ((h = 1), (c = a.globals.dataPoints)), c - h < 2 && (c = h + 1)),
                ...
                (v = { min: h, max: c }),
                  ...
                  "function" == typeof a.config.chart.events.selection && a.config.chart.events.selection(s.ctx, { xaxis: v, yaxis: y });
              }
          },
        },
        {
        ...
        },
        {
          ...
          value: function (t, e) {
            var i = this.w,
              ...
              n = i.globals.minX,
              o = i.globals.maxX;
            i.globals.isTimelineBar && ((r = a.invertedYRatio), (n = i.globals.minY), (o = i.globals.maxY)),
              "left" === this.moveDirection
                ? ((t = n + (i.globals.gridWidth / 15) * r), (e = o + (i.globals.gridWidth / 15) * r))
                : "right" === this.moveDirection && ((t = n - (i.globals.gridWidth / 15) * r), (e = o - (i.globals.gridWidth / 15) * r)),
              i.globals.isTimelineBar || ((t < i.globals.initialMinX || e > i.globals.initialMaxX) && ((t = n), (e = o)));
            var l = { min: t, max: e };
      ...
      a(t, [
        {
          ...
          value: function (t) {
            ...
            return (
              ...
              r.globals.isXNumeric && ((p = (x = this.closestInMultiArray(c, d, b, u)).index), (g = x.j), null !== p && ((b = r.globals.seriesXvalues[p]), (g = (x = this.closestInArray(c, b)).index))),
          ...
          value: function (t) {
            ...
            for (
              var x = function (t, r) {
                  ...
                  (f = i.getSeriesName({ fn: x.yLbTitleFormatter, index: a, seriesIndex: a, j: s })),
                    "treemap" === c.config.chart.type && (f = x.yLbTitleFormatter(String(c.config.series[a].data[s].x), { series: c.globals.series, seriesIndex: a, dataPointIndex: s, w: c }));
                  var b = c.config.tooltip.inverseOrder ? r : t;
                  if (c.globals.axisCharts) {
                    var m = function (t) {
                      return x.yLbFormatter(c.globals.series[t][s], { series: c.globals.series, seriesIndex: t, dataPointIndex: s, w: c });
                    };
                    l
                      ? ((x = i.getFormatters(b)), (f = i.getSeriesName({ fn: x.yLbTitleFormatter, index: b, seriesIndex: a, j: s })), (p = c.globals.colors[b]), (e = m(b)))
                      : (h && h.target && h.target.getAttribute("fill") && (p = h.target.getAttribute("fill")), (e = m(a)));
                  }
                  null === s && (e = x.yLbFormatter(c.globals.series[a], n(n({}, c), {}, { seriesIndex: a, dataPointIndex: a }))),
                    i.DOMHandling({ i: a, t: b, j: s, ttItems: o, values: { val: e, xVal: d, xAxisTTVal: u, zVal: g }, seriesName: f, shared: l, pColor: p });
                },
                b = 0,
        ...
        },
        {
          ...
          value: function (t) {
            ...
            var e = t.t,
              ...
              u = null;
            (u = i[e].children),
              o.config.tooltip.fillSeriesColor && ((i[e].style.backgroundColor = n), (u[0].style.display = "none")),
            ...
            u[0] &&
              ...
              (o.config.tooltip.marker.fillColors && Array.isArray(o.config.tooltip.marker.fillColors) && (n = o.config.tooltip.marker.fillColors[e]), (u[0].style.backgroundColor = n)),
            o.config.tooltip.marker.show || (u[0].style.display = "none"),
            null !== g) && ((i[e].querySelector(".apexcharts-tooltip-text-z-label").innerHTML = o.config.tooltip.z.title), (i[e].querySelector(".apexcharts-tooltip-text-z-value").innerHTML = void 0 !== g ? g : ""));
        ...
        },
        {
          ...
          value: function (t) {
            ...
            a.globals.isXNumeric && "datetime" === a.config.xaxis.type
              ? (r = new W(this.ctx).xLabelFormat(a.globals.ttKeyFormatter, d, d, { i: void 0, dateFormatter: new Y(this.ctx).formatDate, w: this.w }))
            ...
            return (
              ...
              a.globals.seriesZ.length > 0 && a.globals.seriesZ[e].length > 0 && (o = c(a.globals.seriesZ[e][i], a)),
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (e.target.classList.contains("apexcharts-".concat(r, "-rect"))) {
              ...
              if (
                (n.tooltipLabels.drawSeriesTexts({ ttItems: i.ttItems, i: l, j: h, shared: !1, e: e }),
                ...
                a > o.globals.gridWidth / 2 && (a = c - n.tooltipRect.ttWidth / 2 + g),
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (a.target.classList.contains("apexcharts-marker")) {
              ...
              if (
                (l.tooltipLabels.drawSeriesTexts({ ttItems: s.ttItems, i: e, j: i, shared: !l.showOnIntersect && o.config.tooltip.shared, e: a }),
          ...
          value: function (t) {
            ...
            if (
              ...
              (r.globals.isBarHorizontal && n.tooltipUtil.hasBars()) || !r.config.tooltip.shared
                ? ((h = d.x), (c = d.y), (i = Array.isArray(r.config.stroke.width) ? r.config.stroke.width[e] : r.config.stroke.width), (l = h))
            ...
            if (
              ...
              !p || (r.globals.isBarHorizontal && n.tooltipUtil.hasBars()) || (c = c + g - 2 * (r.globals.series[e][u] < 0 ? g : 0)),
                n.tooltipRect.ttHeight + c > r.globals.gridHeight
                  ? ((c = r.globals.gridHeight - n.tooltipRect.ttHeight + r.globals.translateY), (o.style.top = c + "px"))
          ...
          value: function (t) {
            ...
            if (d.contains("apexcharts-bar-area") || d.contains("apexcharts-candlestick-area") || d.contains("apexcharts-rangebar-area")) {
              ...
              a.globals.comboCharts && (n = parseInt(g.parentNode.getAttribute("data:realIndex"), 10)),
                r.tooltipLabels.drawSeriesTexts({ ttItems: i.ttItems, i: n, j: s, y1: y ? parseInt(y, 10) : null, y2: w ? parseInt(w, 10) : null, shared: !r.showOnIntersect && a.config.tooltip.shared, e: e }),
                a.config.tooltip.followCursor
                  ? a.globals.isBarHorizontal
                    ? ((o = v - f.left + 15), (l = m - r.dataPointsDividedHeight + p / 2 - r.tooltipRect.ttHeight / 2))
                    : ((o = a.globals.isXNumeric ? b - x / 2 : b - r.dataPointsDividedWidth + x / 2), (l = e.clientY - f.top - r.tooltipRect.ttHeight / 2 - 15))
                  : a.globals.isBarHorizontal
                  ? ((o = b) < r.xyRatios.baseLineInvertedY && (o = b - r.tooltipRect.ttWidth), (l = m - r.dataPointsDividedHeight + p / 2 - r.tooltipRect.ttHeight / 2))
      ...
      a(t, [
        ...
        },
        {
          ...
          value: function () {
            ...
            return (
              o.indexOf("right") > -1 && (r = r + t.globals.svgWidth - a + 10), o.indexOf("bottom") > -1 && (n = n + t.globals.svgHeight - s - 10), (e.style.left = r + "px"), (e.style.top = n + "px"), { x: r, y: n, ttWidth: a, ttHeight: s }
            );
          },
        },
        {
        ...
        },
        {
          ...
          value: function (t) {
            var e = t.chartCtx,
              ...
              r = e.w,
              n = this.getElTooltip();
            ((i.tooltipRect = { x: 0, y: 0, ttWidth: n.getBoundingClientRect().width, ttHeight: n.getBoundingClientRect().height }), (i.e = s), !i.tooltipUtil.hasBars() || r.globals.comboCharts || i.isBarShared) ||
              (this.tConfig.onDatasetHover.highlightDataSeries && new M(e).toggleSeriesOnHover(s, s.target.parentNode));
          ...
          value: function (t, e, i, a, s) {
            ...
            if (r) {
              if (
                ...
                this.tooltipUtil.hasBars() && ((this.barSeriesHeight = this.tooltipUtil.getBarsHeight(h)), this.barSeriesHeight > 0))
              ) {
                ...
                c = function (s, r) {
                  ...
                  for (var A = 0; A < a.globals.dataPoints; A++) {
                    var S = i.barHelpers.getStrokeWidth(s, A, b),
                      ...
                      L = null;
                    i.isHorizontal
                      ? ((L = i.drawStackedBarPaths(n(n({}, C), {}, { zeroW: u, barHeight: y, yDivision: d }))), (w = i.series[s][A] / i.invertedYRatio))
                      : ((L = i.drawStackedColumnPaths(n(n({}, C), {}, { xDivision: c, barWidth: w, zeroH: g }))), (y = i.series[s][A] / i.yRatio[i.yaxisIndex])),
                      (h = L.y),
                      (l = L.x),
                      p.push(l),
                      x.push(h);
          ...
          value: function (t) {
            ...
            if (g > 0) {
              ...
              this.prevXVal[g - 1][u] < 0
                ? (x = this.series[g][u] >= 0 ? this.prevX[g - 1][u] + f - 2 * (this.isReversed ? f : 0) : this.prevX[g - 1][u])
                : this.prevXVal[g - 1][u] >= 0 && (x = this.series[g][u] >= 0 ? this.prevX[g - 1][u] : this.prevX[g - 1][u] - f + 2 * (this.isReversed ? f : 0)),
                (e = x);
            } else e = r;
        ...
        },
        {
          ...
          value: function (t) {
            ...
            var A = l.move(k, r),
              S = l.move(k, y);
            return (
              o.globals.previousPaths.length > 0 && (S = this.getPreviousPath(p, c, !0)),
              (A =
                l.move(k, w) +
                l.line(k + s / 2, w) +
                l.line(k + s / 2, m) +
      ...
      a(t, [
        ...
        },
        {
          ...
          value: function (t, e, i, a) {
            ...
            s.globals.hasNegs || a
              ? (r = s.config.plotOptions[t].reverseNegativeShade ? (o.percent < 0 ? (o.percent / 100) * (1.25 * n) : (1 - o.percent / 100) * (1.25 * n)) : o.percent <= 0 ? 1 - (1 + o.percent / 100) * n : (1 - o.percent / 100) * n)
              : ((r = 1 - o.percent / 100), "treemap" === t && (r = (1 - o.percent / 100) * (1.25 * n)));
            var l = o.color,
              h = new f();
            return (
              s.config.plotOptions[t].enableShades &&
                (r < 0 && (r = 0), (l = "dark" === this.w.config.theme.mode ? f.hexToRgba(h.shadeColor(-1 * r, o.color), s.config.fill.opacity) : f.hexToRgba(h.shadeColor(r, o.color), s.config.fill.opacity))),
        ...
        },
        {
          ...
          value: function (t, e, i) {
            ...
            r.distributed || "heatmap" !== t || ((h = a.globals.minY), (c = a.globals.maxY)),
              void 0 !== r.colorScale.min && ((h = r.colorScale.min < a.globals.minY ? r.colorScale.min : a.globals.minY), (c = r.colorScale.max > a.globals.maxY ? r.colorScale.max : a.globals.maxY));
            ...
            for (var h = o ? 0 : l.length - 1; o ? h < l.length : h >= 0; o ? h++ : h--) {
              ...
              for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, x = 0; x < l[h].length; x++) {
                ...
                if (
                  ...
                  c.add(k),
                  k.attr({ fill: v, i: h, index: h, j: x, val: l[h][x], "stroke-width": this.strokeWidth, stroke: e.config.plotOptions.heatmap.useFillColorAsStroke ? v : e.globals.stroke.colors[0], color: v }),
      ...
      a(t, [
        {
          ...
          value: function (t) {
            ...
            if (
              ...
              o.attr({ transform: "translate(".concat(v, ", ").concat(y, ") scale(").concat(p, ")") }),
              o.add(k),
              this.ret.add(o),
          ...
          value: function (t, e) {
            ...
            for (var d = 0; d < t.length; d++) {
              ...
              "pie" === this.chartType || "polarArea" === this.chartType
                ? (w = f.polarToCartesian(this.centerX, this.centerY, i.globals.radialSize / 1.25 + i.config.plotOptions.pie.dataLabels.offset, (o + u / 2) % this.fullAngle))
                : "donut" === this.chartType && (w = f.polarToCartesian(this.centerX, this.centerY, (i.globals.radialSize + this.donutSize) / 2 + i.config.plotOptions.pie.dataLabels.offset, (o + u / 2) % this.fullAngle)),
                g.add(v);
              var k = 0;
              if (
                (!this.initialAnim || i.globals.resized || i.globals.dataChanged
                  ? this.animBeginArr.push(0)
                  : (0 === (k = (u / this.fullAngle) * i.config.chart.animations.speed) && (k = 1), (this.animDur = k + this.animDur), this.animBeginArr.push(this.animDur)),
                this.dynamicAnim && i.globals.dataChanged
                  ...
                  : this.animatePaths(v, { size: this.sliceSizes[d], endAngle: h, startAngle: o, i: d, totalItems: t.length - 1, animBeginArr: this.animBeginArr, dur: k }),
                i.config.plotOptions.pie.expandOnClick && "polarArea" !== this.chartType && v.click(this.pieClicked.bind(this, d)),
                ...
                if (0 !== u && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                  ...
                  I.node.classList.add("apexcharts-pie-label"),
                    i.config.chart.animations.animate && !1 === i.globals.resized && (I.node.classList.add("apexcharts-pie-label-delay"), (I.node.style.animationDelay = i.config.chart.animations.speed / 940 + "s")),
        ...
        },
        {
          ...
          value: function (t, e, i, a, s, r) {
            ...
            l.globals.dataChanged &&
              ...
              r.prevEndAngle &&
              ((n = o.getPiePath({ me: o, startAngle: r.prevStartAngle, angle: r.prevEndAngle < r.prevStartAngle ? this.fullAngle + r.prevEndAngle - r.prevStartAngle : r.prevEndAngle - r.prevStartAngle, size: c })), t.attr({ d: n })),
              0 !== r.dur
                ? t
        ...
        },
        {
          ...
          value: function (t) {
            var e = t.me,
              ...
              n = (Math.PI * (r - 90)) / 180,
              o = a + i;
            Math.ceil(o) >= this.fullAngle + (this.w.config.plotOptions.pie.startAngle % this.fullAngle) && (o = this.fullAngle + (this.w.config.plotOptions.pie.startAngle % this.fullAngle) - 0.01),
            ...
            return "donut" === e.chartType
              ? [].concat(b, ["L", u.x, u.y, "A", e.donutSize, e.donutSize, 0, x, 0, p.x, p.y, "L", h, c, "z"]).join(" ")
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            if (
              (r
                ? ((n = t.total.color), (c = t.total.fontSize), (d = t.total.fontFamily), (g = t.total.fontWeight), (p = t.total.label), (f = t.total.formatter(i)))
              ...
              t.forEach(function (t, o) {
                ...
                for (var m = 0; m < c.linePathsTo.length; m++) {
                  var v = e.graphics.renderPaths(
                    n(n({}, d), {}, { pathFrom: null === b ? c.linePathsFrom[m] : b, pathTo: c.linePathsTo[m], strokeWidth: Array.isArray(e.strokeWidth) ? e.strokeWidth[o] : e.strokeWidth, fill: "none", drawShadow: !1 })
                  );
                  h.add(v);
        ...
        },
        {
          ...
          value: function (t, e) {
            var i = "middle",
              ...
              s = t.y;
            return (
              Math.abs(t.x) >= 10 ? (t.x > 0 ? ((i = "start"), (a += 10)) : t.x < 0 && ((i = "end"), (a -= 10))) : (i = "middle"), Math.abs(t.y) >= e - 10 && (t.y < 0 ? (s -= 10) : t.y > 0 && (s += 10)), { textAnchor: i, newX: a, newY: s }
            );
          },
        },
        {
      ...
      a(s, [
          ...
          value: function (t) {
            ...
            for (var o = 0; o < t.series.length; o++) {
              ...
              l.add(u),
                ...
                this.animatePaths(u, { centerX: t.centerX, centerY: t.centerY, endAngle: g, startAngle: d, size: t.size, i: o, totalItems: 2, animBeginArr: 0, dur: 0, isTrack: !0, easing: e.globals.easing });
            }
            return a;
          },
        },
        {
          ...
          value: function (t) {
            ...
            var u = null;
            this.radialDataLabels.show && (u = this.renderInnerDataLabels(this.radialDataLabels, { hollowSize: l, centerX: t.centerX, centerY: t.centerY, opacity: g })),
            ...
            for (var m = x ? t.series.length - 1 : 0; x ? m >= 0 : m < t.series.length; x ? m-- : m++) {
              ...
              var y = a.fillPath({ seriesNumber: m, size: t.size, value: t.series[m] }),
                ...
                C = void 0;
              e.globals.dataChanged && ((k = this.startAngle), (C = Math.round((this.totalAngle * f.negToZero(e.globals.previousPaths[m])) / 100) + k)),
              ...
              var M = 0;
              !this.initialAnim || e.globals.resized || e.globals.dataChanged || ((M = ((S - w) / 360) * e.config.chart.animations.speed), (this.animDur = M / (1.2 * t.series.length) + this.animDur), this.animBeginArr.push(this.animDur)),
                e.globals.dataChanged && ((M = ((S - w) / 360) * e.config.chart.animations.dynamicAnimation.speed), (this.animDur = M / (1.2 * t.series.length) + this.animDur), this.animBeginArr.push(this.animDur)),
                this.animatePaths(z, {
                  centerX: t.centerX,
                  centerY: t.centerY,
                  endAngle: S,
          ...
          value: function (t) {
            ...
            if (0 === n) {
              ...
              l.globals.isXNumeric && (d = (l.globals.seriesX[i][0] - l.globals.minX) / this.lineCtx.xRatio + l.config.markers.offsetX),
                h.push(d),
                c.push(f.isNumber(e[r][0]) ? o + l.config.markers.offsetY : null),
                h.push(a + l.config.markers.offsetX),
                c.push(f.isNumber(e[r][n + 1]) ? s + l.config.markers.offsetY : null);
        ...
        },
        {
          ...
          value: function (t, e, i) {
            ...
            (this.xDivision = a.globals.gridWidth / (a.globals.dataPoints - ("on" === a.config.xaxis.tickPlacement ? 1 : 0))),
              ...
              (this.elSeries = s.group({ class: "apexcharts-series", seriesName: f.escapeString(a.globals.seriesNames[i]) })),
          ...
          value: function (t) {
            for (
              ...
              (c = M.areaPaths),
                ...
                this._handleMarkersAndLabels({ pointsPos: I, series: e, x: s, y: r, prevY: y, i: a, j: P, realIndex: i });
            }
          ...
          value: function (t) {
            ...
            if ((Array.isArray(f.config.stroke.curve) && (x = Array.isArray(u) ? f.config.stroke.curve[u[i]] : f.config.stroke.curve[i]), "smooth" === x)) {
              ...
              f.globals.hasNullValues
                ? (null !== e[i][s] &&
                    (null !== e[i][s + 1]
                      ? ((h = p.move(o, l) + p.curve(o + v, l, r - v, n, r + 1, n)), (c = p.move(o + 1, l) + p.curve(o + v, l, r - v, n, r + 1, n) + p.line(r, m) + p.line(o, m) + "z"))
                      : ((h = p.move(o, l)), (c = p.move(o, l) + "z"))),
                  d.push(h),
                  g.push(c))
                : ((h += p.curve(o + v, l, r - v, n, r, n)), (c += p.curve(o + v, l, r - v, n, r, n))),
                (o = r),
                (l = n),
                s === e[i].length - 2 && ((c = c + p.curve(o, l, r, n, r, m) + p.move(r, n) + "z"), f.globals.hasNullValues || (d.push(h), g.push(c)));
            } else {
              if (null === e[i][s + 1]) {
                h += p.move(r, n);
              ...
              null === e[i][s] && ((h += p.move(r, n)), (c += p.move(r, m))),
                "stepline" === x ? ((h = h + p.line(r, null, "H") + p.line(null, n, "V")), (c = c + p.line(r, null, "H") + p.line(null, n, "V"))) : "straight" === x && ((h += p.line(r, n)), (c += p.line(r, n))),
                s === e[i].length - 2 && ((c = c + p.line(r, m) + p.move(r, n) + "z"), d.push(h), g.push(c));
            }
      ...
      if (0 !== t.length)
        return (
          ...
          (function (t, e, i) {
            ...
            : ((h = s.cutArea(r(e), n)), n.push(s.getCoordinates(e)), i(t, [], h, n)),
          n
        );
      ...
      a(t, [
                ...
                n.forEach(function (r, n) {
                  ...
                  if (i.globals.dataChanged) {
                    ...
                    e.dynamicAnim.enabled &&
                      ...
                      ((y = e.dynamicAnim.speed), i.globals.previousPaths[o][n] && i.globals.previousPaths[o][n].rect && (b = i.globals.previousPaths[o][n].rect), e.animateTreemap(u, b, m, y));
                  }
        ...
        },
        {
          ...
          value: function (t) {
            ...
            return (i = t[2] - t[0]), (a = t[3] - t[1]), (s = i * a), (r = Math.pow(s, 0.5)), Math.min(r / n, parseInt(e.config.dataLabels.style.fontSize, 10));
          },
        },
        {
        ...
        },
        {
          ...
          value: function (t) {
            var e = t.firstVal,
              ...
              g = l,
              u = c(h, i, a);
            0 === e.minHour && 1 === e.minDate && ((d = 0), (g = f.monthMod(e.minMonth)), (o = "month"), (h = e.minDate), r++),
              this.timeScaleArray.push({ position: d, value: g, unit: o, year: this._getYear(a, u, 0), month: f.monthMod(u), day: h });
        ...
        },
        {
          ...
          value: function (t) {
            ...
            for (var m = c, v = 0; v < l; v++)
              g >= 60 && ((g = 0), 24 === (b += 1) && (b = 0)), (m = n + m), this.timeScaleArray.push({ position: m, value: g, unit: h, hour: b, minute: g, day: u, year: this._getYear(r, p, 0), month: f.monthMod(p) }), g++;
          },
        },
        {
      ...
      a(t, [
        {
          ...
          value: function () {
            ...
            (t.axisCharts = ["line", "area", "bar", "rangeBar", "candlestick", "scatter", "bubble", "radar", "heatmap", "treemap"].indexOf(i) > -1),
              ...
              b.setAttrs(t.dom.elWrap, { id: t.chartClass.substring(1), class: "apexcharts-canvas " + t.chartClass.substring(1) }),
                ...
                (e.config.chart.events.selection = function (t, a) {
                  i.forEach(function (t) {
                    ...
                    var o = i.w.config.yaxis.reduce(function (t, e, a) {
                      return [].concat(g(t), [n(n({}, i.w.config.yaxis[a]), {}, { min: s[0].min, max: s[0].max })]);
                    }, []);
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            return (
              ...
              a ? (new b(this.ctx).pathMouseDown(a, null), a.node ? a.node : null) : (console.warn("toggleDataPointSelection: Element not found"), null)
            );
          },
        },
        {
          ...
          e &&
            ("string" == typeof e
              ? a.regex.isRgb.test(e)
                ? ((i = a.regex.rgb.exec(e.replace(a.regex.whitespace, ""))), (this.r = parseInt(i[1])), (this.g = parseInt(i[2])), (this.b = parseInt(i[3])))
                : a.regex.isHex.test(e) &&
                  ((i = a.regex.hex.exec(4 == (s = e).length ? ["#", s.substring(1, 2), s.substring(1, 2), s.substring(2, 3), s.substring(2, 3), s.substring(3, 4), s.substring(3, 4)].join("") : s)),
      ...
      a.extend(a.Color, {
        ...
        at: function (t) {
          return this.destination
            ? ((t = t < 0 ? 0 : t > 1 ? 1 : t), new a.Color({ r: ~~(this.r + (this.destination.r - this.r) * t), g: ~~(this.g + (this.destination.g - this.g) * t), b: ~~(this.b + (this.destination.b - this.b) * t) }))
            : this;
        },
      }),
    ...
    (a.PathArray = function (t, e) {
      ...
      a.extend(a.PathArray, {
        ...
        parse: function (t) {
          ...
          t =
            "string" == typeof t
              ? t.replace(a.regex.numbersWithDots, h).replace(a.regex.pathLetters, " $& ").replace(a.regex.hyphen, "$1 -").trim().split(a.regex.delimiter)
        ...
        create: function (t, e) {
          (this.value = 0),
            ...
            "number" == typeof t
              ...
              : "string" == typeof t
              ? (e = t.match(a.regex.numberAndUnit)) && ((this.value = parseFloat(e[1])), "%" == e[5] ? (this.value /= 100) : "s" == e[5] && (this.value *= 1e3), (this.unit = e[5]))
      ...
      a.extend(a.Element, {
        transform: function (e, i) {
          ...
          return "object" !== t(e)
            ...
            : ((s = new a.Matrix(this)), (i = !!i || !!e.relative), null != e.a && (s = i ? s.multiply(new a.Matrix(e)) : new a.Matrix(e)), this.attr("transform", s));
        },
      }),
      a.extend(a.Element, {
      ...
      (a.Transformation = a.invent({
        create: function (e, i) {
          ...
          else if ("object" === t(e)) for (a = 0, s = this.arguments.length; a < s; ++a) this[this.arguments[a]] = e[this.arguments[a]];
      ...
      (a.off = function (t, e, i) {
        ...
        if (-1 != s)
          ...
          } else if (n) for (var h in a.listeners[s]) for (var o in a.listeners[s][h]) n === o && a.off(t, [h, n].join("."));
          else if (r) {
            if (a.listeners[s][r]) {
      ...
      (a.Doc = a.invent({
        create: function (t) {
          t &&
            ("svg" == (t = "string" == typeof t ? i.getElementById(t) : t).nodeName ? this.constructor.call(this, t) : (this.constructor.call(this, a.create("svg")), t.appendChild(this.node), this.size("100%", "100%")),
            this.namespace().defs());
        },
        inherit: a.Container,
        extend: {
      ...
      (a.Stop = a.invent({
        ...
        extend: {
          update: function (t) {
            return (
              ("number" == typeof t || t instanceof a.Number) && (t = { offset: arguments[0], color: arguments[1], opacity: arguments[2] }),
            ...
            return (
              a.on(s, "load", function () {
                ...
                null !== e &&
                  ...
                  "function" == typeof i._loaded && i._loaded.call(i, { width: s.width, height: s.height, ratio: s.width / s.height, url: t }));
              }),
      ...
      for (var c = t.slice(s, r || h), d = n.slice(o, l || h), g = 0, u = { pos: [0, 0], start: [0, 0] }, f = { pos: [0, 0], start: [0, 0] }; ; ) {
        if (
          ...
          c[g][0] != d[g][0] || "M" == c[g][0] || ("A" == c[g][0] && (c[g][4] != d[g][4] || c[g][5] != d[g][5]))
            ? (Array.prototype.splice.apply(c, [g, 1].concat(a.call(u, c[g]))), Array.prototype.splice.apply(d, [g, 1].concat(a.call(f, d[g]))))
      ...
      morph: function (e) {
        for (var i = this.value, a = this.parse(e), r = 0, n = 0, o = !1, l = !1; !1 !== r || !1 !== n; ) {
          ...
          (o = s(i, !1 !== r && r + 1)),
            ...
            !1 === n && (n = 0 == (h = new SVG.PathArray(c.dest).bbox()).height || 0 == h.width ? a.push(a[0]) - 1 : a.push(["M", h.x + h.width / 2, h.y + h.height / 2]) - 1);
          var c = t(i, r, o, a, n, l);
    ...
    (t.prototype.init = function (t, e) {
      ...
      (t.prototype.drag = function (t) {
        ...
        if ("function" == typeof r) {
          ...
          "object" == typeof r &&
            (null != r.minX && a < r.minX ? (n = (a = r.minX) - this.startPoints.box.x) : null != r.maxX && a > r.maxX - e.width && (n = (a = r.maxX - e.width) - this.startPoints.box.x),
            null != r.minY && s < r.minY ? (o = (s = r.minY) - this.startPoints.box.y) : null != r.maxY && s > r.maxY - e.height && (o = (s = r.maxY - e.height) - this.startPoints.box.y),
            null != r.snapToGrid && ((a -= a % r.snapToGrid), (s -= s % r.snapToGrid), (n -= n % r.snapToGrid), (o -= o % r.snapToGrid)),
            this.el instanceof SVG.G ? this.el.matrix(this.startPoints.transform).transform({ x: n, y: o }, !0) : this.el.move(a, s));
        return i;
      }),
