          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                y &&
                  (M.node.addEventListener("mouseenter", this.pathMouseEnter.bind(this, M)), M.node.addEventListener("mouseleave", this.pathMouseLeave.bind(this, M)), M.node.addEventListener("mousedown", this.pathMouseDown.bind(this, M))),
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              void 0 !== e.globals.seriesColors[this.seriesIndex] && (n = e.globals.seriesColors[this.seriesIndex]),
                "function" == typeof n && (n = n({ seriesIndex: this.seriesIndex, dataPointIndex: t.dataPointIndex, value: t.value, w: e }));
                  ...
                  null !== u && f.isNumber(u)
                    ? ((n = Math.max(n, c[d][g])),
                      ...
                      "candlestick" === this.w.config.chart.type &&
                        ((n = Math.max(n, r.seriesCandleO[d][g])), (n = Math.max(n, r.seriesCandleH[d][g])), (n = Math.max(n, r.seriesCandleL[d][g])), (i = n = Math.max(n, r.seriesCandleC[d][g]))),
            ...
            value: function () {
              ...
              for (var n = e.globals.legendFormatter, o = e.config.legend.inverseOrder, l = o ? a.length - 1 : 0; o ? l >= 0 : l <= a.length - 1; o ? l-- : l++) {
                ...
                e.config.legend.showForNullSeries ||
                  (z.isSeriesNull(l) && -1 === e.globals.collapsedSeriesIndices.indexOf(l) && -1 === e.globals.ancillaryCollapsedSeriesIndices.indexOf(l) && L.classList.add("apexcharts-hidden-null-series")),
            ...
            value: function () {
              ...
              var i = f.getDimensions(this.el),
                a = e.chart.width
                  ...
                  .pop();
              "%" === a
                ? f.isNumber(i[0]) && (0 === i[0].width && (i = f.getDimensions(this.el.parentNode)), (t.svgWidth = (i[0] * parseInt(e.chart.width, 10)) / 100))
