...
!(function (t, e) {
    ...
    i = e(function (t) {
      ...
      (a.rgb.hsl = function (t) {
        ...
        (a.rgb.hsv = function (t) {
          ...
          return (
            0 === d ? (a = r = 0) : ((r = d / u), (e = h(o)), (n = h(s)), (i = h(l)), o === u ? (a = i - n) : s === u ? (a = 1 / 3 + e - i) : l === u && (a = 2 / 3 + n - e), a < 0 ? (a += 1) : a > 1 && (a -= 1)), [360 * a, 100 * r, 100 * u]
          );
        }),
  ...
  (_.prototype = {
    ...
    (_.prototype.spaces = { rgb: ["red", "green", "blue"], hsl: ["hue", "saturation", "lightness"], hsv: ["hue", "saturation", "value"], hwb: ["hue", "whiteness", "blackness"], cmyk: ["cyan", "magenta", "yellow", "black"] }),
    (_.prototype.maxes = { rgb: [255, 255, 255], hsl: [360, 100, 100], hsv: [360, 100, 100], hwb: [360, 100, 100], cmyk: [100, 100, 100, 100] }),
  ...
  H.extend(nt.prototype, {
    ...
    _resolveDataElementOptions: function (t, e) {
      ...
      var r,
        ...
        m = { cacheable: !i };
      if (((i = i || {}), H.isArray(c))) for (o = 0, s = c.length; o < s; ++o) f[(l = c[o])] = Q([i[l], d[l], h[l]], g, e, m);
      else for (o = 0, s = (r = Object.keys(c)).length; o < s; ++o) f[(l = r[o])] = Q([i[l], d[c[l]], d[l], h[l]], g, e, m);
  ...
  W._set("global", { elements: { line: { tension: 0.4, backgroundColor: ut, borderWidth: 3, borderColor: ut, borderCapStyle: "butt", borderDash: [], borderDashOffset: 0, borderJoinStyle: "miter", capBezierPoints: !0, fill: !0 } } });
  var dt = $.extend({
      _type: "line",
      draw: function () {
        var t,
  ...
  function vt(t) {
    var e, n, i, a, r;
    return (
      pt(t) ? ((r = t.width / 2), (e = t.x - r), (n = t.x + r), (i = Math.min(t.y, t.base)), (a = Math.max(t.y, t.base))) : ((r = t.height / 2), (e = Math.min(t.x, t.base)), (n = Math.max(t.x, t.base)), (i = t.y - r), (a = t.y + r)),
  ...
  W._set("bar", { hover: { mode: "label" }, scales: { xAxes: [{ type: "category", offset: !0, gridLines: { offsetGridLines: !0 } }], yAxes: [{ type: "linear" }] } }),
  ...
  var Gt = it.extend({
      ...
      update: function (t) {
        ...
        for (
          i._xScale = i.getScaleForId(a.xAxisID),
            ...
            u && (void 0 !== l.tension && void 0 === l.lineTension && (l.lineTension = l.tension), (r._scale = i._yScale), (r._datasetIndex = i.index), (r._children = o), (r._model = i._resolveDatasetElementOptions(r)), r.pivot()),
            e = 0,
            n = o.length;
          e < n;
          ++e
      ...
      draw: function () {
        ...
        for (
          ...
          H.canvas.clipArea(e.ctx, { left: !1 === t.left ? 0 : a.left - t.left, right: !1 === t.right ? r.width : a.right + t.right, top: !1 === t.top ? 0 : a.top - t.top, bottom: !1 === t.bottom ? r.height : a.bottom + t.bottom }),
          n.dataset.draw(),
  ...
  var Kt = it.extend({
    ...
    update: function (t) {
      var e,
        ...
        l = i._config;
      for (
        void 0 !== l.tension && void 0 === l.lineTension && (l.lineTension = l.tension), r._scale = s, r._datasetIndex = i.index, r._children = o, r._loop = !0, r._model = i._resolveDatasetElementOptions(r), r.pivot(), e = 0, n = o.length;
        e < n;
        ++e
      )
        i.updateElement(o[e], e, t);
  ...
  var yn = $.extend({
    ...
    fit: function () {
      ...
      if ((u ? (e.width = t.maxWidth) : s && (e.width = fn(o) + gn(r)), u ? s && (e.height = fn(o) + gn(r)) : (e.height = t.maxHeight), a.display && s)) {
        ...
        if (u) {
          ...
          b ? ((k = l ? x * c.width + _ * c.offset : _ * (c.height - c.offset)), (M = l ? _ * (f.height - f.offset) : x * f.width + _ * f.offset)) : ((k = c.width / 2), (M = f.width / 2)),
    ...
    _parseValue: function (t) {
      var e, n, i, a;
      return sn(t) ? ((e = +this.getRightValue(t[0])), (n = +this.getRightValue(t[1])), (i = Math.min(e, n)), (a = Math.max(e, n))) : ((e = void 0), (n = t = +this.getRightValue(t)), (i = t), (a = t)), { min: i, max: a, start: e, end: n };
    },
        ...
        (i = S[n] || {}),
          (ln(i.label) && n < S.length) ||
            (n === b.zeroLineIndex && x.offset === k
              ? ((g = _.zeroLineWidth), (m = _.zeroLineColor), (p = _.zeroLineBorderDash || []), (v = _.zeroLineBorderDashOffset || 0))
              : ((g = dn(_.lineWidth, n, 1)), (m = dn(_.color, n, "rgba(0,0,0,0.1)")), (p = _.borderDash || []), (v = _.borderDashOffset || 0)),
            void 0 !== (a = hn(b, i._index || n, k)) &&
              ((r = A(y, a, g)), M ? (o = l = d = c = r) : (s = u = h = f = r), P.push({ tx1: o, ty1: s, tx2: l, ty2: u, x1: d, y1: h, x2: c, y2: f, width: g, color: m, borderDash: p, borderDashOffset: v })));
      ...
      for (
        ...
        (i = (n = b[t]).label),
          ln(i) ||
            ...
            (d = sn(i) ? i.length : 1),
            v ? ((a = s), (h = "top" === m ? ((w ? 1 : 0.5) - d) * u : (w ? 0 : 0.5) * u)) : ((r = s), (h = ((1 - d) * u) / 2)),
      ...
      if (n.display) {
        ...
        if (h) {
          var f,
            ...
            y = c.borderValue;
          e.isHorizontal() ? ((f = d(u, e.left, v) - v / 2), (g = d(u, e.right, b) + b / 2), (m = p = y)) : ((m = d(u, e.top, v) - v / 2), (p = d(u, e.bottom, b) + b / 2), (f = g = y)),
            (l.lineWidth = h),
        ...
        var t = this,
          ...
          a = (t.ticks = (function (t, e) {
            ...
            (r = Math.ceil(g / m) - Math.floor(f / m)) > u && (m = H.niceNum((r * m) / u / l) * l),
              s || Sn(c) ? (n = Math.pow(10, H._decimalPlaces(m))) : ((n = Math.pow(10, c)), (m = Math.ceil(m * n) / n)),
              (i = Math.floor(f / m) * m),
              (a = Math.ceil(g / m) * m),
              s && (!Sn(d) && H.almostWhole(d / m, m / 1e3) && (i = d), !Sn(h) && H.almostWhole(h / m, m / 1e3) && (a = h)),
              (r = (a - i) / m),
  ...
  var Nn = xn.extend({
      ...
      handleTickRangeOptions: function () {
        ...
        (t.min = Rn(e.min, t.min)),
          ...
          t.min === t.max && (0 !== t.min && null !== t.min ? ((t.min = Math.pow(10, Math.floor(In(t.min)) - 1)), (t.max = Math.pow(10, Math.floor(In(t.max)) + 1))) : ((t.min = 1), (t.max = 10))),
          null === t.min && (t.min = Math.pow(10, Math.floor(In(t.max)) - 1)),
          null === t.max && (t.max = 0 !== t.min ? Math.pow(10, Math.floor(In(t.min)) + 1) : 10),
          null === t.minNotZero && (t.min > 0 ? (t.minNotZero = t.min) : t.max < 1 ? (t.minNotZero = Math.pow(10, Math.floor(In(t.max)))) : (t.minNotZero = 1));
      },
      buildTicks: function () {
        var t = this,
          e = t.options.ticks,
      ...
      _configure: function () {
        ...
        xn.prototype._configure.call(t),
          0 === e && ((e = t._getFirstTickValue(t.minNotZero)), (n = Fn(t.options.ticks.fontSize, W.global.defaultFontSize) / t._length)),
          (t._startValue = In(e)),
          (t._valueOffset = n),
  ...
  var Zn = Dn.extend({
      ...
      _drawGrid: function () {
        ...
        if (
          ...
          for (
            a.save(), a.lineWidth = l, a.strokeStyle = u, a.setLineDash && (a.setLineDash(En([s.borderDash, o.borderDash, []])), (a.lineDashOffset = En([s.borderDashOffset, o.borderDashOffset, 0]))), t = i.chart.data.labels.length - 1;
            t >= 0;
            t--
          )
      ...
      determineDataLimits: function () {
        ...
        for (t = 0, n = (l.data.datasets || []).length; t < n; ++t)
          if (l.isDatasetVisible(t))
            if (((a = l.data.datasets[t].data), H.isObject(a[0]))) for (m[t] = [], e = 0, i = a.length; e < i; ++e) (r = li(s, a[e])), g.push(r), (m[t][e] = r);
    ...
    gi = e(function (e, n) {
      e.exports = (function () {
        ...
        function Gt(t, e, n, i, a) {
          ...
          return s <= 0 ? (o = Dt((r = t - 1)) + s) : s > Dt(t) ? ((r = t + 1), (o = s - Dt(t))) : ((r = t), (o = s)), { year: r, dayOfYear: o };
        }
        function qt(t, e, n) {
          var i,
            a,
          ...
          if (!t._d) {
            for (
              i = (function (t) {
                ...
                null != t._dayOfYear && ((o = be(t._a[vt], i[vt])), (t._dayOfYear > Dt(o) || 0 === t._dayOfYear) && (g(t)._overflowDayOfYear = !0), (n = jt(o, 0, t._dayOfYear)), (t._a[bt] = n.getUTCMonth()), (t._a[yt] = n.getUTCDate())),
                e = 0;
              e < 3 && null == t._a[e];
              ++e
            )
            ...
            24 === t._a[xt] && 0 === t._a[_t] && 0 === t._a[wt] && 0 === t._a[kt] && ((t._nextDay = !0), (t._a[xt] = 0)),
          ...
          if (t._f !== a.ISO_8601)
            if (t._f !== a.RFC_2822) {
              ...
              for (i = G(t._f, t._locale).match(E) || [], e = 0; e < i.length; e++)
                (r = i[e]),
                  (n = (s.match(ht(r, t)) || [])[0]) && ((o = s.substr(0, s.indexOf(n))).length > 0 && g(t).unusedInput.push(o), (s = s.slice(s.indexOf(n) + n.length)), (u += n.length)),
                  B[r] ? (n ? (g(t).empty = !1) : g(t).unusedTokens.push(r), pt(r, n, t)) : t._strict && !n && g(t).unusedTokens.push(r);
                      ...
                      ? (function (t) {
                          ...
                          for (a = 0; a < t._f.length; a++)
                            (r = 0),
                              ...
                              (e._f = t._f[a]),
                              Ae(e),
                              m(e) && ((r += g(e).charsLeftOver), (r += 10 * g(e).unusedTokens.length), (g(e).score = r), (null == i || r < i) && ((i = r), (n = e)));
                          c(t, n || e);
                        })(t)
                      : n
                      ? Ae(t)
        ...
        function Xe(t, e) {
          ...
          return (
            Ee(t)
              ...
              : (d = Ze.exec(t))
              ? ((n = "-" === d[1] ? -1 : 1), (u = { y: 0, d: k(d[yt]) * n, h: k(d[xt]) * n, m: k(d[_t]) * n, s: k(d[wt]) * n, ms: k(Ve(1e3 * d[kt])) * n }))
              : (d = $e.exec(t))
              ? ((n = "-" === d[1] ? -1 : 1), (u = { y: Ke(d[2], n), M: Ke(d[3], n), w: Ke(d[4], n), d: Ke(d[5], n), h: Ke(d[6], n), m: Ke(d[7], n), s: Ke(d[8], n) }))
              : null == u
              ? (u = {})
              : "object" == typeof u &&
                ("from" in u || "to" in u) &&
                ((r = Le(u.from)),
                (o = Le(u.to)),
                (a = r.isValid() && o.isValid() ? ((o = Ue(o, r)), r.isBefore(o) ? (s = Je(r, o)) : (((s = Je(o, r)).milliseconds = -s.milliseconds), (s.months = -s.months)), s) : { milliseconds: 0, months: 0 }),
                ((u = {}).ms = a.milliseconds),
                (u.M = a.months)),
            (i = new ze(u)),
        ...
        function Qe(t, e) {
          return function (n, i) {
            ...
            return (
              null === i ||
                isNaN(+i) ||
                (T(e, "moment()." + e + "(period, number) is deprecated. Please use moment()." + e + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), (a = n), (n = i), (i = a)),
        ...
        (Mn.add = en),
          ...
          (Mn.from = function (t, e) {
            return this.isValid() && ((_(t) && t.isValid()) || Le(t).isValid()) ? Xe({ to: this, from: t }).locale(this.locale()).humanize(!e) : this.localeData().invalidDate();
          }),
          (Mn.fromNow = function (t) {
            return this.from(Le(), t);
          }),
          (Mn.to = function (t, e) {
            return this.isValid() && ((_(t) && t.isValid()) || Le(t).isValid()) ? Xe({ from: this, to: t }).locale(this.locale()).humanize(!e) : this.localeData().invalidDate();
          }),
          (Mn.toNow = function (t) {
            return this.to(Le(), t);
          }),
          ...
          (Mn.utcOffset = function (t, e, n) {
            ...
            if (null != t) {
              ...
              return (
                ...
                (this._isUTC = !0),
                null != i && this.add(i, "m"),
                r !== t && (!e || this._changeInProgress ? tn(this, Xe(t - r, "m"), 1, !1) : this._changeInProgress || ((this._changeInProgress = !0), a.updateOffset(this, !0), (this._changeInProgress = null))),
                this
              );
            }
        ...
        (Dn.calendar = function (t, e, n) {
            ...
            for (this._monthsParse || ((this._monthsParse = []), (this._longMonthsParse = []), (this._shortMonthsParse = [])), i = 0; i < 12; i++) {
              if (
                ...
                n &&
                  ...
                  ((this._longMonthsParse[i] = new RegExp("^" + this.months(a, "").replace(".", "") + "$", "i")), (this._shortMonthsParse[i] = new RegExp("^" + this.monthsShort(a, "").replace(".", "") + "$", "i"))),
                n || this._monthsParse[i] || ((r = "^" + this.months(a, "") + "|^" + this.monthsShort(a, "")), (this._monthsParse[i] = new RegExp(r.replace(".", ""), "i"))),
          ...
          (Dn.monthsRegex = function (t) {
            return this._monthsParseExact
              ...
              : (h(this, "_monthsRegex") || (this._monthsRegex = Vt), this._monthsStrictRegex && t ? this._monthsStrictRegex : this._monthsRegex);
          }),
          (Dn.monthsShortRegex = function (t) {
            return this._monthsParseExact
              ? (h(this, "_monthsRegex") || Ht.call(this), t ? this._monthsShortStrictRegex : this._monthsShortRegex)
              : (h(this, "_monthsShortRegex") || (this._monthsShortRegex = Et), this._monthsShortStrictRegex && t ? this._monthsShortStrictRegex : this._monthsShortRegex);
          }),
          (Dn.week = function (t) {
            ...
            for (this._weekdaysParse || ((this._weekdaysParse = []), (this._minWeekdaysParse = []), (this._shortWeekdaysParse = []), (this._fullWeekdaysParse = [])), i = 0; i < 7; i++) {
              if (
                ...
                n &&
                  ...
                  ((this._fullWeekdaysParse[i] = new RegExp("^" + this.weekdays(a, "").replace(".", "\\.?") + "$", "i")),
                ...
                this._weekdaysParse[i] || ((r = "^" + this.weekdays(a, "") + "|^" + this.weekdaysShort(a, "") + "|^" + this.weekdaysMin(a, "")), (this._weekdaysParse[i] = new RegExp(r.replace(".", ""), "i"))),
          ...
          (Dn.weekdaysRegex = function (t) {
            return this._weekdaysParseExact
              ...
              : (h(this, "_weekdaysRegex") || (this._weekdaysRegex = te), this._weekdaysStrictRegex && t ? this._weekdaysStrictRegex : this._weekdaysRegex);
          }),
          (Dn.weekdaysShortRegex = function (t) {
            return this._weekdaysParseExact
              ? (h(this, "_weekdaysRegex") || ie.call(this), t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
              : (h(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = ee), this._weekdaysShortStrictRegex && t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
          }),
          (Dn.weekdaysMinRegex = function (t) {
            return this._weekdaysParseExact
              ? (h(this, "_weekdaysRegex") || ie.call(this), t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
              : (h(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = ne), this._weekdaysMinStrictRegex && t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex);
          }),
          (Dn.isPM = function (t) {
        ...
        return (
          ...
          (ri._bubble = function () {
            var t,
              ...
              l = this._data;
            return (
              (r >= 0 && o >= 0 && s >= 0) || (r <= 0 && o <= 0 && s <= 0) || ((r += 864e5 * Fn(Ln(s) + o)), (o = 0), (s = 0)),
  ...
  function bi(t) {
    return (t.el._scale || {}).getPointPositionForValue
      ...
      : (function (t) {
          ...
          if (
            ("start" === a ? (r = void 0 === n.scaleBottom ? i.bottom : n.scaleBottom) : "end" === a ? (r = void 0 === n.scaleTop ? i.top : n.scaleTop) : void 0 !== n.scaleZero ? (r = n.scaleZero) : i.getBasePixel && (r = i.getBasePixel()),
            null != r)
          ) {
  ...
  function ki(t, e, n, i, a, r) {
    ...
    for (t.beginPath(), o = 0, s = g; o < s; ++o)
      (d = n((u = e[(l = o % g)]._view), l, i)),
        ...
        h && c ? ((b = p.push(u)), (y = v.push(d))) : b && y && (m ? (h && p.push(u), c && v.push(d)) : (wi(t, p, v, b, y), (b = y = 0), (p = []), (v = [])));
  ...
  var Mi = {
      ...
      beforeDatasetsDraw: function (t) {
        ...
        for (n = l.length - 1; n >= 0; --n)
          (e = l[n].$filler) &&
            e.visible &&
            ((a = (i = e.el)._view), (r = i._children || []), (o = e.mapper), (s = a.backgroundColor || W.global.defaultColor), o && s && r.length && (H.canvas.clipArea(u, t.chartArea), ki(u, r, o, a, s, i._loop), H.canvas.unclipArea(u)));
      },
    },
      ...
      if (e.display) {
        ...
        H.each(t.legendItems, function (e, i) {
          ...
          h.setWidth(t.minSize.width),
            y
              ? i > 0 && _ + g + n.padding > t.left + t.minSize.width && ((w = d.y += x), d.line++, (_ = d.x = t.left + b(l, u[d.line])))
              : i > 0 && w + x > t.top + t.minSize.height && ((_ = d.x = _ + t.columnWidths[d.line] + n.padding), d.line++, (w = d.y = t.top + b(o, s[d.line])));
          var k = h.x(_);
          !(function (t, e, i) {
            if (!(isNaN(p) || p <= 0)) {
              c.save();
