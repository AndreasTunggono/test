...
!(function (t, e) {
    ...
    L = {
      ...
      roundedRect: function (t, e, n, i, a, r) {
        if (r) {
          ...
          t.moveTo(e, l),
            s < u && l < d
              ? (t.arc(s, l, o, -P, -T), t.arc(u, l, o, -T, 0), t.arc(u, d, o, 0, T), t.arc(s, d, o, T, P))
              : s < u
              ? (t.moveTo(s, n), t.arc(u, l, o, -T, T), t.arc(s, l, o, T, P + T))
              : l < d
  ...
  var B = {
      ...
      toPadding: function (t) {
        var e, n, i, a;
        return M.isObject(t) ? ((e = +t.top || 0), (n = +t.right || 0), (i = +t.bottom || 0), (a = +t.left || 0)) : (e = n = i = a = +t || 0), { top: e, right: n, bottom: i, left: a, height: e + i, width: a + n };
      },
      ...
      advance: function () {
        for (var t, e, n, i, a = this.animations, r = 0; r < a.length; )
          (e = (t = a[r]).chart),
            ...
            t.currentStep >= n ? (V.callback(t.onAnimationComplete, [t], e), (e.animating = !1), a.splice(r, 1)) : ++r;
      },
    },
    J = V.options.resolve,
  ...
  V.extend(et.prototype, {
    ...
    _resolveDataElementOptions: function (t, e) {
      ...
      var r,
        ...
        p = { cacheable: !i };
      if (((i = i || {}), V.isArray(c))) for (o = 0, s = c.length; o < s; ++o) f[(l = c[o])] = J([i[l], d[l], h[l]], g, e, p);
      else for (o = 0, s = (r = Object.keys(c)).length; o < s; ++o) f[(l = r[o])] = J([i[l], d[c[l]], d[l], h[l]], g, e, p);
      ...
      n.fullCircles &&
        (function (t, e, n, i) {
          var a,
            r = n.endAngle;
          for (
            i && ((n.endAngle = n.startAngle + it), at(t, n), (n.endAngle = r), n.endAngle === n.startAngle && n.fullCircles && ((n.endAngle += it), n.fullCircles--)),
              t.beginPath(),
  ...
  z._set("global", { elements: { line: { tension: 0.4, backgroundColor: lt, borderWidth: 3, borderColor: lt, borderCapStyle: "butt", borderDash: [], borderDashOffset: 0, borderJoinStyle: "miter", capBezierPoints: !0, fill: !0 } } });
  var ut = X.extend({
      _type: "line",
      draw: function () {
        var t,
      ...
      draw: function (t) {
        ...
        e.skip ||
          ((void 0 === t || V.canvas._isPointInArea(e, t)) &&
            ((n.strokeStyle = e.borderColor || u), (n.lineWidth = dt(e.borderWidth, l.elements.point.borderWidth)), (n.fillStyle = e.backgroundColor || u), V.canvas.drawPoint(n, i, r, o, s, a)));
      },
    }),
  ...
  function bt(t, e, n) {
    ...
    return (
      V.isObject(s) ? ((i = +s.top || 0), (a = +s.right || 0), (r = +s.bottom || 0), (o = +s.left || 0)) : (i = a = r = o = +s || 0),
  ...
  z._set("bar", { hover: { mode: "label" }, scales: { xAxes: [{ type: "category", offset: !0, gridLines: { offsetGridLines: !0 } }], yAxes: [{ type: "linear" }] } }),
    z._set("global", { datasets: { bar: { categoryPercentage: 0.8, barPercentage: 0.9 } } });
  var Dt = nt.extend({
  ...
  z._set("horizontalBar", {
    ...
    z._set("global", { datasets: { horizontalBar: { categoryPercentage: 0.8, barPercentage: 0.9 } } });
  var Bt = Dt.extend({
      _getValueScaleId: function () {
        return this.getMeta().xAxisID;
      },
  ...
  function qt(t) {
    var e, n, i, a;
    return V.isObject(t) ? ((e = t.top), (n = t.right), (i = t.bottom), (a = t.left)) : (e = n = i = a = t), { top: e, right: n, bottom: i, left: a };
  }
      ...
      updateBezierControlPoints: function () {
        ...
        if (a.options.elements.line.capBezierPoints)
          for (t = 0, e = l.length; t < e; ++t)
            (n = l[t]._model),
              Vt(n, s) &&
                (t > 0 && Vt(l[t - 1]._model, s) && ((n.controlPointPreviousX = u(n.controlPointPreviousX, s.left, s.right)), (n.controlPointPreviousY = u(n.controlPointPreviousY, s.top, s.bottom))),
                t < l.length - 1 && Vt(l[t + 1]._model, s) && ((n.controlPointNextX = u(n.controlPointNextX, s.left, s.right)), (n.controlPointNextY = u(n.controlPointNextY, s.top, s.bottom))));
      },
      draw: function () {
        var t,
          e = this.chart,
        ...
        for (
          ...
          V.canvas.clipArea(e.ctx, { left: !1 === t.left ? 0 : a.left - t.left, right: !1 === t.right ? r.width : a.right + t.right, top: !1 === t.top ? 0 : a.top - t.top, bottom: !1 === t.bottom ? r.height : a.bottom + t.bottom }),
          n.dataset.draw(),
  ...
  var je = X.extend({
        ...
        if (p.length) {
          ...
          c.filter &&
            ...
            (x = (function (t, e) {
              ...
              return (
                (n.font = V.fontString(u, e._titleFontStyle, e._titleFontFamily)),
                V.each(e.title, f),
      ...
      handleEvent: function (t) {
        ...
        return (
          ...
          (e = !V.arrayEquals(n._active, n._lastActive)) && ((n._lastActive = n._active), (i.enabled || i.custom) && ((n._eventPosition = { x: t.x, y: t.y }), n.update(!0), n.pivot())),
          e
        );
      },
    }),
  ...
  function gn(t, e) {
    return V.extend(V.options._parseFont({ fontFamily: ln(e.fontFamily, t.fontFamily), fontSize: ln(e.fontSize, t.fontSize), fontStyle: ln(e.fontStyle, t.fontStyle), lineHeight: ln(e.lineHeight, t.lineHeight) }), {
  ...
  z._set("scale", {
    ...
    ticks: { beginAtZero: !1, minRotation: 0, maxRotation: 50, mirror: !1, padding: 0, reverse: !1, display: !0, autoSkip: !0, autoSkipPadding: 0, labelOffset: 0, callback: rn.formatters.values, minor: {}, major: {} },
  });
  var bn = X.extend({
    zeroLineIndex: 0,
    getPadding: function () {
    ...
    _parseValue: function (t) {
      var e, n, i, a;
      return on(t) ? ((e = +this.getRightValue(t[0])), (n = +this.getRightValue(t[1])), (i = Math.min(e, n)), (a = Math.max(e, n))) : ((e = void 0), (n = t = +this.getRightValue(t)), (i = t), (a = t)), { min: i, max: a, start: e, end: n };
    },
        ...
        (i = S[n] || {}),
          (sn(i.label) && n < S.length) ||
            (n === b.zeroLineIndex && y.offset === w
              ...
              : ((g = un(_.lineWidth, n, 1)), (p = un(_.color, n, "rgba(0,0,0,0.1)")), (m = _.borderDash || []), (v = _.borderDashOffset || 0)),
    ...
    _n = xn.extend({
      ...
      getPixelForValue: function (t, e, n) {
        ...
        return (
          ...
          (void 0 !== i || (void 0 !== t && isNaN(e))) && ((a = o._getLabels()), (t = V.valueOrDefault(i, t)), (e = -1 !== (r = a.indexOf(t)) ? r : e), isNaN(e) && (e = t)),
        ...
        var t = this,
          ...
          a = (t.ticks = (function (t, e) {
            ...
            (r = Math.ceil(g / p) - Math.floor(f / p)) > u && (p = V.niceNum((r * p) / u / l) * l),
              s || Mn(c) ? (n = Math.pow(10, V._decimalPlaces(p))) : ((n = Math.pow(10, c)), (p = Math.ceil(p * n) / n)),
              (i = Math.floor(f / p) * p),
              (a = Math.ceil(g / p) * p),
              s && (!Mn(d) && V.almostWhole(d / p, p / 1e3) && (i = d), !Mn(h) && V.almostWhole(h / p, p / 1e3) && (a = h)),
              (r = (a - i) / p),
  ...
  var Rn = xn.extend({
      ...
      handleTickRangeOptions: function () {
        ...
        (t.min = On(e.min, t.min)),
          ...
          t.min === t.max && (0 !== t.min && null !== t.min ? ((t.min = Math.pow(10, Math.floor(Fn(t.min)) - 1)), (t.max = Math.pow(10, Math.floor(Fn(t.max)) + 1))) : ((t.min = 1), (t.max = 10))),
      ...
      _configure: function () {
        ...
        xn.prototype._configure.call(t),
          0 === e && ((e = t._getFirstTickValue(t.minNotZero)), (n = In(t.options.ticks.fontSize, z.global.defaultFontSize) / t._length)),
          (t._startValue = Fn(e)),
          (t._valueOffset = n),
  ...
  var Nn = V.valueOrDefault,
    ...
    Wn = {
      ...
      ticks: { showLabelBackdrop: !0, backdropColor: "rgba(255,255,255,0.75)", backdropPaddingY: 2, backdropPaddingX: 2, callback: rn.formatters.linear },
      pointLabels: {
        display: !0,
        fontSize: 10,
        callback: function (t) {
          ...
          ? (function (t) {
              ...
              for (e = 0; e < d; e++) {
                (i = t.getPointPosition(e, t.drawingArea + 5)),
                  ...
                  (l = a.lineHeight),
                  (u = t.pointLabels[e]),
                  (n = V.isArray(u) ? { w: V.longestText(s, s.font, u), h: u.length * l } : { w: s.measureText(u).width, h: l }),
      ...
      determineDataLimits: function () {
        ...
        for (t = 0, n = (l.data.datasets || []).length; t < n; ++t)
          if (l.isDatasetVisible(t))
            if (((a = l.data.datasets[t].data), V.isObject(a[0]))) for (p[t] = [], e = 0, i = a.length; e < i; ++e) (r = si(s, a[e])), g.push(r), (p[t][e] = r);
  ...
  function _i(t, e, n, i, a, r) {
    ...
    for (t.beginPath(), o = 0, s = g; o < s; ++o)
      (d = n((u = e[(l = o % g)]._view), l, i)),
        ...
        h && c ? ((b = m.push(u)), (x = v.push(d))) : b && x && (p ? (h && m.push(u), c && v.push(d)) : (yi(t, m, v, b, x), (b = x = 0), (m = []), (v = [])));
  ...
  var ki = {
      ...
      beforeDatasetsDraw: function (t) {
        ...
        for (n = l.length - 1; n >= 0; --n)
          (e = l[n].$filler) &&
            e.visible &&
            ((a = (i = e.el)._view), (r = i._children || []), (o = e.mapper), (s = a.backgroundColor || z.global.defaultColor), o && s && r.length && (V.canvas.clipArea(u, t.chartArea), _i(u, r, o, a, s, i._loop), V.canvas.unclipArea(u)));
      },
    },
  ...
  var Ii = X.extend({
    ...
    fit: function () {
      var t,
        ...
        a = e.isHorizontal();
      n.display
        ? ((t = (V.isArray(n.text) ? n.text.length : 1) * V.options._parseFont(n).lineHeight + 2 * n.padding), (e.width = i.width = a ? e.maxWidth : t), (e.height = i.height = a ? t : e.maxHeight))
    ...
    draw: function () {
      ...
      if (n.display) {
        ...
        (e.fillStyle = V.valueOrDefault(n.fontColor, z.global.defaultFontColor)),
          ...
          (e.textBaseline = "middle");
        var g = n.text;
        if (V.isArray(g)) for (var p = 0, m = 0; m < g.length; ++m) e.fillText(g[m], 0, p, i), (p += s);
